...
formula <- as.formula("Rating ~ Orientation + 
                      anger + 
                      fear + 
                      disgust +
                      sadness +
...
MATCHED_PATH <- file.path(DIR_PATH, "matched_replies_all_mahalanobis.csv")
...
MATCHED_PATH <- file.path(DIR_PATH, "matched_replies_all_glm.csv")
